...
namespace Crossdyne.Security.Abstractions
{
    ...
    public interface ISrpServer
    {
        ...
        SrpSessionState GetSrpChallenge(string login, byte[] verifierBytes, byte[] salt, SrpGroup srpGroup);
        ...
        string VerifySrpProof(SrpSessionState sessionState, string a, string m1, SrpGroup srpGroup);
    }
}